...
const translations = {
  en: {
    ...
    cardMetricStatus: 'status',
    cardMetricStatusValue: 'Secure',
    cardMetricUptime: 'uptime',
    cardMetricAudit: 'audit score',
  ...
  fr: {
    ...
    cardMetricStatus: 'statut',
    cardMetricStatusValue: 'Sécurisé',
    cardMetricUptime: 'disponibilité',
    cardMetricAudit: 'score audit',
